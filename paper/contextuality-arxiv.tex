...
% TODO physics: minimal dimension d*, explicit orthonormal representations, noise robustness / visibility (à la Tamer et al. §IV) for the n=9, 10, 11 and C13(1,5) witnesses
% TODO theory: upper bound on theta for triangle-free graphs (e.g. via degree / Hoffman) to bracket gap_max(n)
% TODO literature: theta of Ramsey graphs in the Shannon-capacity literature (Alon); differentiate
% TODO: n=12 status — local search from the winners for graphs with triangles beating 0.930021
...
% TODO: table from certificates/summary.csv (theta primal/dual/SCS, certified lb/ub, rank X, d*, visibility); JSON files in the repository
